...
document.addEventListener("DOMContentLoaded", function () {
  ...
  $("#showPassBtnRegister").click(() =>
    togglePasswordInput("password", "showPassBtnRegister")
  );
  $("#showPassconfirmBtnRegister").click(() =>
    togglePasswordInput("confirmpassword", "showPassconfirmBtnRegister")
  );
  ...
  function OcultarBackgroundDesenfocado() {
    var BackgroundDesenfocado = document.querySelector(
  ...
  const inputDatetime = document.getElementById("datetime"),
    ...
    lblRelationshipElements =
      document.getElementsByClassName("lbl-relationship"),
  ...
  const inputPostalcode = document.getElementById("postalcode"),
    failedIconPostalcode = document.querySelector(
      ".postalcode-checkout-failed"
    ),
    correctIconPostalcode = document.querySelector(
      ".postalcode-checkout-correct"
    ),
    tooltipErrorPostalcode = document.querySelector(
      ".tooltip-error-postalcode"
    );
  let statePostalcode = false;

  const selectLocalidad = document.getElementById("localidad"),
    failedIconLocalidad = document.querySelector(".localidad-checkout-failed"),
    correctIconLocalidad = document.querySelector(
  ...
  const inputStreetnumber = document.getElementById("streetnumber"),
    failedIconStreetnumber = document.querySelector(
      ".streetnumber-checkout-failed"
    ),
    correctIconStreetnumber = document.querySelector(
      ".streetnumber-checkout-correct"
    ),
    tooltipErrorStreetnumber = document.querySelector(
      ".tooltip-error-streetnumber"
    );
  ...
  const inputMatricula = document.getElementById("matricula"),
    ...
    correctIconMatricula = document.querySelector(
  ...
  const inputConfirmpassword = document.getElementById("confirmpassword"),
    failedIconConfirmpassword = document.querySelector(
      ".confirmpassword-checkout-failed"
    ),
    correctIconConfirmpassword = document.querySelector(
      ".confirmpassword-checkout-correct"
    ),
    tooltipErrorConfirmpassword = document.querySelector(
      ".tooltip-error-confirmpassword"
    );
  ...
  inputDni.addEventListener("input", () => {
    ...
    if (valueDni === "") {
      ...
      tooltipErrorDni.textContent =
        "Campo inválido. No puede dejar el campo vacío.";
      stateDni = false;
    } else if (
      /[!@#$%^&*()_+{}\[\]:;<>,.?~\\-]/.test(valueDni) &&
      /[A-Za-z]/.test(valueDni)
    ) {
      hiddenElement(correctIconDni);
      showElement(failedIconDni);
      tooltipErrorDni.textContent =
        "Campo inválido. No debe contener símbolos ni letras.";
      stateDni = false;
      ...
      showElement(failedIconDni);
      tooltipErrorDni.textContent =
        "Campo inválido. No puede contener símbolos.";
      stateDni = false;
    } else if (
      /^[0-9]+$/.test(valueDni) &&
      (valueDni.length === 7 || valueDni.length === 8)
    ) {
      showElement(correctIconDni);
      hiddenElement(failedIconDni);
      tooltipErrorDni.textContent = "";
      ...
      showElement(failedIconDni);
      tooltipErrorDni.textContent =
        "Campo inválido. No pueden introducir más de 8 dígitos.";
      stateDni = false;
    }
    checkState1();
  });
  ...
  inputPhone.addEventListener("input", () => {
    ...
    if (valuePhone === "") {
      ...
      showElement(failedIconPhone);
      tooltipErrorPhone.textContent =
        "Campo inválido. No debe contener letras.";
      statePhone = false;
      ...
      showElement(failedIconPhone);
      tooltipErrorPhone.textContent =
        "Campo inválido. Cantidad de dígitos insuficientes.";
      statePhone = false;
    } else {
      hiddenElement(correctIconPhone);
      showElement(failedIconPhone);
      tooltipErrorPhone.textContent =
        "Campo inválido. No pueden introducir más de 10 dígitos.";
      statePhone = false;
    }
    checkState1();
  });
  ...
  inputDateTime.addEventListener("input", () => {
    ...
    if (
      ...
      hiddenElement(correctIconDatetime);
      tooltipErrorDatetime.textContent =
        "Campo inválido. Debe seleccionar una fecha válida.";
      stateDatetime = false;
    }
    checkState1();
  });
  ...
  selectGender.addEventListener("input", () => {
    ...
    if (selectedValue === "") {
      hiddenElement(correctIconGender);
      showElement(failedIconGender);
      tooltipErrorGender.textContent =
        "Campo inválido. No puede dejar el campo vacío.";
      stateGender = false;
    } else {
      hiddenElement(failedIconGender);
  ...
  inputPostalcode.addEventListener("input", () => {
    ...
    if (valuePostalcode === "") {
      ...
      /[!@#$%^&*()_+{}\[\]:;<>,.?~\\-]/.test(valuePostalcode) &&
      /[A-Za-z]/.test(valuePostalcode)
    ) {
      showElement(failedIconPostalcode);
      hiddenElement(correctIconPostalcode);
      tooltipErrorPostalcode.textContent =
      ...
      tooltipErrorLocalidad.textContent =
        "Campo inválido. No puede dejar el campo vacío.";
      ...
      /^[0-9]+$/.test(valuePostalcode) &&
      valuePostalcode.length === 4
    ) {
      hiddenElement(failedIconPostalcode);
      showElement(correctIconPostalcode);
      tooltipErrorPostalcode.textContent = "";
      ...
      tooltipErrorPostalcode.textContent =
        "Campo inválido. No pueden introducir más de 4 dígitos.";
      statePostalcode = false;
  ...
  inputStreet.addEventListener("input", () => {
    ...
    if (valueStreet === "") {
      hiddenElement(correctIconStreet);
      showElement(failedIconStreet);
      tooltipErrorStreet.textContent =
        "Campo inválido. No puede dejar el campo vacío.";
      stateStreet = false;
      ...
      /[!@#$%^&*()_+{}\[\]:;<>,.?~\\-]/.test(valueStreet) &&
      /[0-9]/.test(valueStreet)
    ) {
      hiddenElement(correctIconStreet);
      showElement(failedIconStreet);
      tooltipErrorStreet.textContent =
        "Campo inválido. No puede ingresar símbolos ni números.";
      stateStreet = false;
    } else if (/[!@#$%^&*()_+{}\[\]:;<>,.?~\\-]/.test(valueStreet)) {
      hiddenElement(correctIconStreet);
      showElement(failedIconStreet);
      tooltipErrorStreet.textContent =
        "Campo inválido. No puede ingresar símbolos.";
      stateStreet = false;
    } else {
      hiddenElement(correctIconStreet);
      showElement(failedIconStreet);
      tooltipErrorStreet.textContent =
        "Campo inválido. No puede ingresar números.";
      stateStreet = false;
    }
    checkState2();
  });
  ...
  inputStreetnumber.addEventListener("input", () => {
    ...
    if (valueStreetnumber === "") {
      ...
      /[!@#$%^&*()_+{}\[\]:;<>,.?~\\-]/.test(valueStreetnumber) &&
      /[A-Za-z]/.test(valueStreetnumber)
    ) {
      hiddenElement(correctIconStreetnumber);
      showElement(failedIconStreetnumber);
      tooltipErrorStreetnumber.textContent =
      ...
      /^[0-9]+$/.test(valueStreetnumber) &&
      valueStreetnumber.length === 3
    ) {
      showElement(correctIconStreetnumber);
      hiddenElement(failedIconStreetnumber);
      tooltipErrorStreetnumber.textContent = "";
      ...
      showElement(failedIconStreetnumber);
      tooltipErrorStreetnumber.textContent =
        "Campo inválido. No pueden introducir más de 3 dígitos.";
      stateStreetnumber = false;
    }
    checkState2();
  });
  ...
  inputEmail.addEventListener("input", () => {
    ...
    const emailRegex =
      /^[a-zA-Z0-9._\-!#&~\u00C0-\u017F]+@[a-zA-Z0-9.-]+\.[a-zA-Z]{2,4}$/;
    ...
    if (valueEmail === "") {
      ...
      showElement(failedIconEmail);
      tooltipErrorEmail.textContent =
        "Campo inválido. Dirección de correo electrónico inválida.";
      stateEmail = false;
    }
    checkState4();
  });
      ...
      for (const modalPopupBtn of modalPopupBtns) {
        modalPopupBtn.addEventListener("click", () => {
          ...
          if (userInput === code) {
            ...
            document.querySelector(".confirmemail").style.backgroundColor =
              "#52ec61";
  ...
  inputMatricula.addEventListener("input", () => {
    ...
    if (valueMatricula === "") {
      ...
      /[!@#$%^&*()_+{}\[\]:;<>,.?~\\-]/.test(valueMatricula) &&
      /[A-Za-z]/.test(valueMatricula)
    ) {
      showElement(failedIconMatricula);
      hiddenElement(correctIconMatricula);
      tooltipErrorMatricula.textContent =
      ...
      hiddenElement(correctIconMatricula);
      tooltipErrorMatricula.textContent =
        "Campo inválido. No pueden introducir menos de 4 dígitos.";
      stateMatricula = false;
    } else {
      showElement(failedIconMatricula);
      hiddenElement(correctIconMatricula);
  ...
  selectTypeuser.addEventListener("input", () => {
    ...
    if (selectedValueTypeuser === "") {
      showElement(failedIconTypeuser);
      hiddenElement(correctIconTypeuser);
      tooltipErrorTypeuser.textContent =
        "Campo inválido. No puede dejar el campo vacío.";
      stateTypeuser = false;
  ...
  inputPassword.addEventListener("input", () => {
    ...
    if (valuePassword === "") {
      ...
      hiddenElement(correctIconPassword);
      tooltipErrorPassword.textContent =
        "Campo inválido. No puede contener espacios en blanco.";
      statePassword = false;
      ...
      hiddenElement(correctIconPassword);
      tooltipErrorPassword.textContent =
        "Campo inválido. No pueden introducir menos de 8 dígitos.";
      statePassword = false;
    } else {
      showElement(failedIconPassword);
      hiddenElement(correctIconPassword);
      tooltipErrorPassword.textContent =
        "Campo inválido. No pueden introducir más de 12 dígitos.";
      statePassword = false;
    }
    checkState4();
  });
  ...
  inputConfirmpassword.addEventListener("input", () => {
    ...
    if (valueConfirmpassword === "") {
      ...
      hiddenElement(correctIconConfirmpassword);
      tooltipErrorConfirmpassword.textContent =
        "Campo inválido. Las contraseñas no coinciden.";
      stateConfirmpassword = false;
    }
    checkState4();
  });
  ...
  stagebtn3b.addEventListener("click", () => {
    ...
    animateNextStage(
      ...
      signupContent4,
      console.log("click en linea 1337")
    );
    // } else {
  ...
  stagebtn4b.addEventListener("click", () => {
    if (checkState4() === true) {
      const nthChild = [document.querySelector(".stage:nth-child(5)")];
      animateNextStage(
        document.querySelector(".stageno-4"),
  ...
  stagebtn5b.addEventListener("click", () => {
    if (checkState5() === true) {
      const nthChild = [document.querySelector(".stage:nth-child(6)")];
      animateNextStage(
        document.querySelector(".stageno-5"),
        ...
        signupContent6,
        console.log("click en linea 1393")
      );
    } else {
  ...
  stagebtn6b.addEventListener("click", () => {
    if (checkState6() === true) {
      ...
      setTimeout(() => {
        ...
        stageElement6.style.transition =
          "background-color 1s ease-in-out, color 1s ease-in-out";
      ...
      const popUpAnimationContent =
        document.getElementsByClassName("popupAnimation");
      ...
      .then((Data) => {
        ...
        if (Data.length === 0) {
          ...
          if (filteredData.length === 0) {
            ...
            hiddenElement(correctIconPostalcode);
            tooltipErrorPostalcode.textContent =
              "Campo inválido. No existe el código postal.";
            statePostalcode = false;

            showElement(failedIconLocalidad);
            hiddenElement(correctIconLocalidad);
            tooltipErrorLocalidad.textContent =
              "Campo inválido. No existe localidad para el código postal.";
            stateLocalidad = false;
          } else {
  ...
  function crearMapa(coordenadas) {
    ...
    L.marker([coordenadas.lat, coordenadas.lng], { icon: customIcon })
      .addTo(map)
      .bindPopup("<span style='color: red;'>Su ubicación</span>");
  ...
  const paginationBtnsMobile = document.querySelector(
  ...
  nextBtnStage1.addEventListener("click", () => {
    if (checkState1() === true) {
      ...
      document
        .querySelector(".current-item-mobile")
        .classList.add("green-background");
      stageno0.style.transition =
        "background-color 1s ease-in-out, color 1s ease-in-out";
  ...
  prevBtnStage2.addEventListener("click", () => {
    ...
    document
      .querySelector(".current-item-mobile")
      .classList.remove("green-background");
    document
      .querySelector(".current-item-mobile")
  ...
  nextBtnStage5.addEventListener("click", () => {
    if (checkState5() === true) {
      ...
      document
        .querySelector(".last-item-mobile")
        .classList.add("white-background");
      document
        .querySelector(".current-item-mobile")
        .classList.add("green-background");
  ...
  nextBtnStage6.addEventListener("click", () => {
    if (checkState6() === true) {
      ...
      signupContent5.classList.add("hiddenElement");
      signupContent6.classList.add("hiddenElement");
      console.log("click en linea 2020");
  ...
  signin.addEventListener("submit", function (event) {
    ...
    console.log(event, "click en linea 2085");
  });
